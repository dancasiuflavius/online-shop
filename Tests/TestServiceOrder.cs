...
using online_shop.Services.Models;
...
namespace Tests
{
    public class TestServiceOrder
    {
        ...
        public void testFindOrderByIdTrue()
        {
            ...
            Order order1 = new Order("O1A",1, 3, "Pending");
        ...
        public void testFindProductByIdFalse()
        {
            ...
            Order order1 = new Order("O1A", 1, 3, "Pending");
            Order order2 = new Order("O1B", 2, 2, "Delivered");
        ...
        public void testUpdateOrderTrue()
        {
            ...
            Assert.True(_serviceOrders.UpdateOrder("O1A", 1, 1, "Delivered", "aX"));
        }
        [Fact]
        public void testUpdateOrderFalse()
        {
            ...
            Assert.False(_serviceOrders.UpdateOrder("OA1", 1, 1, "Delivered", "aX"));
        }
    }
}
